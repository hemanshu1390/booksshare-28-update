...
const Landing = () => {
     ...
     <section className="relative p-[px]">
      ...
      <div className="lg:flex flex-row-reverse ">
          ...
          <div className="hero-text lg:w-[560px] ">
              ...
              <div className="lg:w-[400px]  flex justify-between ps-4 pe-4 p-4 first-letter: sm:p-4">
  ...
  <div className="lg:w-[450px] p-3 lg:pr-[50px]">
 ...
 <Card
    ...
    >
      ...
      <CardBody className="relative py-14 px-6 md:px-5">
        ...
        <button
      className=" outline-none   font-extrabold text-muted  text-white  ">
        {item.btn}
      </button>
      </CardBody>
    </Card>
