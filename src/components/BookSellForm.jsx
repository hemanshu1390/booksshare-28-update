...
const BookSellForm = () => {
  ...
  return (
    <div>
      ...
      <div className='py-6'>
        <label htmlFor="" className='text-current lg:text-[20px] text-[18px]'>Price of Book's</label><br />
        <input type="checkbox" color='black' className='' /><span className="text-blue-gray-600"> Price Will be 50 % off for Every Book</span>
      </div>
      <div>
